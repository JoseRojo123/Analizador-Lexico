...
public class Scanner {
	...
	if(c == '<'){
        ...
        //Si no es ninguno de los caracteres antes declarados, lo manda al estado 30 que arroja un error
        else{
            estado=30;
            lexema+=c;
        }
	...
	case 13:
            //Verifica si el caracter actual es un salto de l[inea y si el iterador est[a en la [ultima posici[on de la cadena
		if (c == '\n' || i == source.length() - 1) {
		...
		if(Character.isDigit(c)){
                ...
                //Verifica si el c es una E  para indicar que se va a elevar a un exponente un número (Caso para un d[igito)
                    ...
                    //Verfica si c es un punto indicando que ser[a un número decimal
                        ...
                        //Crea el Token de solo los números antes del punto porque no hubo otro número después del punto
                        else{
